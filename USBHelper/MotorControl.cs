...
namespace Motor
{
    ...
    public class MotorControl: INotifyPropertyChanged
    {
        ...
        public string SetMsg = "/1aM1j16m30h15L100V16000aM2j16m30h15L100V16000aM3j16m30h15L100V16000aM4j16m50h15L30V16000R\r";
        ...
        public void MoveAll(int x = 0, int y = 0, int z = 0,int h=0)
        {
            if (serialPort.IsOpen)
            {
                //发送0位移指令会一直运动，所以切换位1指令
